...
public class PackClassCreatorProxy {
    ...
    private int mInterfaceType = 0; // 0-Parcelable;1-PackEncoder;

    public PackClassCreatorProxy(Elements elementUtils, TypeElement classElement, int interfaceType) {
    ...
    private void generatePackableMethods(StringBuilder builder) {
        builder.append(TAB_SPACE).append("private "+mTargetClassName+"() {\n");
        builder.append(TAB_SPACE).append("}\n\n");
        ...
        builder.append(TAB_SPACE).append("@Override\n");
        builder.append(TAB_SPACE).append("public byte[] encode(@NonNull MyObject obj) {\n");
        builder.append(TAB_SPACE).append(TAB_SPACE).append("return PackEncoder.marshal(obj);\n");
        builder.append(TAB_SPACE).append("}\n\n");

        builder.append(TAB_SPACE).append("@Override\n");
        builder.append(TAB_SPACE).append("public MyObject decode(@NonNull byte[] bytes, int offset, int length) {\n");
        builder.append(TAB_SPACE).append(TAB_SPACE).append("return PackDecoder.unmarshal(bytes, offset, length, MyObject.CREATOR);\n");
        builder.append(TAB_SPACE).append("}\n\n");
    }
